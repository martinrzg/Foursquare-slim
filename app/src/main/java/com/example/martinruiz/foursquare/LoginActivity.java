...
public class LoginActivity extends AppCompatActivity {
    ...
    private void saveOnPrefs (String token){
    ...
    private void ensureUi() {
        boolean isAuthorized = !TextUtils.isEmpty(preferences.getString("token",""));
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (FoursquareOAuth.isPlayStoreIntent(intent)) {
                    toastMessage(LoginActivity.this, "To do this, you’ll need the latest version of Foursquare installed.");
